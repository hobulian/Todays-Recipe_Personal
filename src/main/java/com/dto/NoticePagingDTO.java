...
public class NoticePagingDTO {
	...
	private int countPage = 5; //밑의 페이징블럭을 5개씩 나누는 용도
	...
	public NoticePagingDTO(int total, int nowPage, int countPerPage) {
		setNowPage(nowPage);
	...
	public String toString() {
		return "NoticePagingDTO [nowPage=" + nowPage + ", startPage=" + startPage + ", endPage=" + endPage + ", total="
				+ total + ", countPerPage=" + countPerPage + ", lastPage=" + lastPage + ", start=" + start + ", end="
				+ end + ", countPage=" + countPage + "]";
	}
